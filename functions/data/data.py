...
class Data(PyGData):
    ...
    def select(self, idx, update_sub=True, update_super=True):
        ...
        for key, item in self:
            ...
            # can skip them here
            if key in warn_keys and is_debug_enabled():
                print(
